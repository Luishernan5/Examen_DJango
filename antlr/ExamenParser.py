...
class ExamenParser ( Parser ):
    ...
    class ProgramContext(ParserRuleContext):
        ...
        def EOF(self):
            return self.getToken(ExamenParser.EOF, 0)

        def statement(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(ExamenParser.StatementContext)
            else:
                return self.getTypedRuleContext(ExamenParser.StatementContext,i)


        def NEWLINE(self, i:int=None):
            if i is None:
                return self.getTokens(ExamenParser.NEWLINE)
            else:
                return self.getToken(ExamenParser.NEWLINE, i)

        def getRuleIndex(self):
            return ExamenParser.RULE_program
    ...
    def program(self):
        ...
        localctx = ExamenParser.ProgramContext(self, self._ctx, self.state)
        ...
        try:
            ...
            while _la==2 or _la==9:
                ...
                self.statement()
                self.state = 11
                self.match(ExamenParser.NEWLINE)
                self.state = 17
                self._errHandler.sync(self)
                _la = self._input.LA(1)

            self.state = 18
            self.match(ExamenParser.EOF)
    ...
    class StatementContext(ParserRuleContext):
        ...
        def assign(self):
            return self.getTypedRuleContext(ExamenParser.AssignContext,0)


        def print_(self):
            return self.getTypedRuleContext(ExamenParser.PrintContext,0)


        def getRuleIndex(self):
            return ExamenParser.RULE_statement
    ...
    def statement(self):
        ...
        localctx = ExamenParser.StatementContext(self, self._ctx, self.state)
    ...
    class AssignContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return ExamenParser.RULE_assign
    ...
    def assign(self):
        ...
        localctx = ExamenParser.AssignContext(self, self._ctx, self.state)
    ...
    class PrintContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return ExamenParser.RULE_print
    ...
    def print_(self):
        ...
        localctx = ExamenParser.PrintContext(self, self._ctx, self.state)
    ...
    class ExprContext(ParserRuleContext):
        ...
        def INT(self):
            return self.getToken(ExamenParser.INT, 0)
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = ExamenParser.ExprContext(self, _parentctx, _parentState)
